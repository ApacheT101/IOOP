...
public class ProductM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton15.setText("Delete Catalogue ID");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jButton14, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(jButton19, javax.swing.GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE))
                        .addGap(18, 18, 18)))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
    ...
    private void CreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CreateMouseClicked
        if(jTextField8.getText().isEmpty()||jTextField6.getText().isEmpty()||jTextField7.getText().isEmpty()||jTextField5.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please fill All Field");
        }else{
            category.clear();
            boolean input = false;
    ...
    private void Update5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Update5MouseClicked
        if(jTextField17.getText().isEmpty()||jTextField18.getText().isEmpty()||jTextField21.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please fill All Field");
        }else{
            boolean input = false;
    ...
    private void Update6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Update6MouseClicked
        if(jTextField19.getText().isEmpty()||jTextField20.getText().isEmpty()||jTextField13.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please fill All Field");
        }else{
            boolean input = false;
